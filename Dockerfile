...
# R packages
ENV PACK_R="abind BH cba clValid corrplot curl DBI dendextend devtools doSNOW eigenfaces extrafont FactoMineR flexclust geometry ggplot2 gplots hash Hmisc httr jsonlite klaR kohonen languageR lme4 lmerTest magic Matrix matrixStats mda memoise MetStaT multcomp multisom plotly plotrix pryr qtlcharts R6 rcdk Rcpp rmarkdown RMySQL rsm rstudioapi RJSONIO RUnit squash tools vegan xlsx"
