...
# R packages
ENV PACK_R="abind ape BH cba clValid corrplot curl DBI dendextend devtools doSNOW eigenfaces extrafont FactoMineR flexclust geometry ggplot2 gplots hash Hmisc httr jsonlite klaR kohonen languageR limma lme4 lmerTest magic Matrix matrixStats mda memoise metabolomics MetStaT mixOmics multcomp multisom picante plotly plotrix pryr qtlcharts R6 rcdk Rcpp rmarkdown RMySQL rsm rstudioapi RJSONIO RUnit squash tools vegan xlsx"
